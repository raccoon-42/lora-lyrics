  ...
  \begin{columns}[c]
    ...
    \begin{column}{0.45\textwidth}
      ...
      \begin{itemize}
        ...
        \item RoBERTa-base 5-way attribution classifier, accuracy \textbf{0.873}, macro-F1 \textbf{0.86}
...
\begin{frame}{Three comparisons we run}
  \vfill
  \large
...
\begin{frame}{Perplexity --- a clean diagonal, yet it disagrees too}
  ...
  \begin{tabular}{@{}lrrrrr@{}}
    ...
    \bottomrule
  \end{tabular}
  \take{Both blocks specialize (own-artist = column min, \textbf{bold}); but SW \emph{raises} every diagonal --- it buys lexicon/attribution at a likelihood cost. Perplexity rewards what SW penalizes.}
\end{frame}
...
\begin{frame}{Blending: 50/50 weights $\neq$ 50/50 style}
  ...
  \take{All four Gojira-SW blends cross over away from 0.5 ($\alpha^*$ = 0.47--0.65): the partner usually wins a 50/50 mix. Tool alone shifted 0.17 (plain) $\to$ 0.61 (SW) --- the loss, not the weights, decides.}
\end{frame}
